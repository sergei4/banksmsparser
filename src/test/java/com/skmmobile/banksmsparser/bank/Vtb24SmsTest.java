...
public class Vtb24SmsTest extends AbsXmlBankSmsTest {
    ...
    public Vtb24SmsTest(SmsParserFactory smsParserFactory) {
        super("vtb24", smsParserFactory);
    }
    ...
    protected void smsTest() {
        ...
        checkBankSms(
                ...
                "1000",
                "");
        checkBankSms("Списано 20000.00р Счет*7747 внут.перевод Баланс 11024.04р 20:33",
                "payment",
                "Счет*7747",
                "20000",
                "");
        checkBankSms(
                "Поступление 20000.00р Счет*4115 Баланс 275273.51р 20:33",
                "popolnenie",
                "Счет*4115",
                "20000",
                "");
